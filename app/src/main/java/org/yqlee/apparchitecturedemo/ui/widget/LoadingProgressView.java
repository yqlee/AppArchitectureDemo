...
public class LoadingProgressView extends View {
    ...
    public LoadingProgressView(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.LoadingProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.LoadingProgressWheel_matProg_circleRadius, circleRadius);
        ...
        float baseSpinSpeed = a.getFloat(R.styleable.LoadingProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.LoadingProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);
